...
function About() {
  return (
    ...
    <img src="https://www.motocms.com/blog/wp-content/uploads/2017/11/about-us-page-concept-illustrati-1.jpg" alt="about-img" width={1000} className=" col-md-12"/>
<div className="about-text col-md-12 mt-5">
